...
print("Task 1: Caesar Cipher Encryption and Decryption")
...
print("Caesar Cipher Encrypted Message:", caesar_ciphertext)

caesar_decrypted_message = caesar_cipher_decrypt(caesar_ciphertext, shift)
print("Caesar Cipher Decrypted Message:", caesar_decrypted_message)

# Task 2: Find all possible Cipher Text & Plaintext pairs for Caesar Cipher
print("Task 2: Find all possible Cipher Text & Plaintext pairs for Caesar Cipher")
caesar_pairs = generate_caesar_cipher_pairs(plaintext)
for idx, pair in enumerate(caesar_pairs, 1):
    print("{}): Cipher Text: {}, Plaintext: {}".format(idx, pair[0], pair[1]))

# Task 3: Mono-alphabetic Cipher Encryption and Decryption
print("Task 3: Mono-alphabetic Cipher Encryption and Decryption")
monoalphabetic_key = input("Enter the Mono-alphabetic Cipher key: ")
...
try:
    ...
    print("Mono-alphabetic Cipher Encrypted Message:", monoalphabetic_ciphertext)

    monoalphabetic_decrypted_message = monoalphabetic_cipher_decrypt(monoalphabetic_ciphertext, monoalphabetic_key)
    print("Mono-alphabetic Cipher Decrypted Message:", monoalphabetic_decrypted_message)
